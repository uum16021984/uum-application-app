            ...
            <div class="card-flush">
                ...
                <div class="card-body">
                    ...
                    <p style="font-size:0.8rem;color:#6b7280;margin-bottom:10px;">
                        Grade: ${job.grade}<br>School: ${job.school}<br>Deadline: ${job.deadline}<br>Posted by: ${job.postedBy}
                    </p>
                    ...
                    <div style="display:flex;justify-content:flex-end;">
                        ...
                        ` : isFull ? `<span style="color:#dc2626;font-weight:700;font-size:0.85rem;"><i class="fas fa-ban" style="margin-right:4px;"></i>No vacancies remaining</span>` : ``}
                    </div>
                </div>
            </div>
        `;
