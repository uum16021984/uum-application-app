...
async function loadSchoolAdminApplications() {
    ...
    // applications is already server-filtered to approved apps for this school
    if (applications.length === 0) {
        contentArea.innerHTML = `
            <div class="card">
                <p>No JSM-approved applications for your school yet.</p>
            </div>
        `;
        return;
    }
    ...
    contentArea.innerHTML = `
        <div class="mb-4">
            <h2 class="text-2xl font-bold primary-text">${applications.length} Approved Application${applications.length !== 1 ? 's' : ''}</h2>
        </div>
...
`).join("");
    ...
    contentArea.innerHTML = `
        ...
        async function loadAdminSchoolDashboard() {
            ...
            // applications array already contains only approved apps for this school
            // (filtered server-side for adminSchool role)
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-6">
                        <div class="card text-center">
                            ...
                            <div class="text-gray-600">JSM-Approved Applications</div>
                        </div>
                    </div>
                </div>
                <div class="card">
