                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <i class="fas fa-sort text-gray-400" onclick="sortTable(3)" style="cursor:pointer; margin-left:6px;" title="Sort by date applied"></i>
                                </th>
                                <th onclick="sortTable(4)">JSM Decision <i class="fas fa-sort text-gray-400"></i></th>
                                <th onclick="sortTable(5)">School Decision <i class="fas fa-sort text-gray-400"></i></th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
