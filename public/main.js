...
function selectJobAndApply(jobId) {
 ...
 if(currentUser.role === "adminJSM" || currentUser.role === "adminSchool"){
    ...
    if (banner) banner.style.display = currentUser.savedDraft ? 'flex' : 'none';
        ...
        // Clicking a notification dismisses it entirely (like tapping a
        // notification in any other app) — no confirmation needed, unlike the
        // explicit trash-icon delete which double-checks first.
