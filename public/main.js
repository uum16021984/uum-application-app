...
async function exportAllApplicationsToExcel() {
    ...
    const headers = [
        'No.',
        // Section A
        'Nama Penuh', 'No. IC Baru', 'No. IC Lama', 'Tarikh Lahir', 'Umur', 'Agama',
        'No. Pasport', 'Kewarganegaraan', 'Jantina', 'Telefon', 'Emel',
        'Alamat Tetap', 'Alamat Surat-menyurat',
        // Job info
        'Jawatan Dipohon', 'Gred', 'Bidang Pengkhususan', 'Pusat Pengajian', 'Tarikh Permohonan',
        // Section C – Education
        'PhD – Institusi', 'PhD – Tahun', 'PhD – CGPA', 'PhD – Bidang',
        'Master – Institusi', 'Master – Tahun', 'Master – CGPA', 'Master – Bidang',
        'Degree – Institusi', 'Degree – Tahun', 'Degree – CGPA', 'Degree – Bidang',
        'Diploma – Institusi', 'Diploma – Tahun', 'Diploma – CGPA', 'Diploma – Bidang',
        'SPM – Institusi', 'SPM – Tahun', 'SPM – CGPA', 'SPM – Bidang',
        // Section F
        'Jawatan Sekarang', 'Majikan Sekarang', 'Gaji Sekarang', 'Tarikh Mula Kerja',
        // Section G (first 2 rows)
        'Exp 1 – Jawatan', 'Exp 1 – Majikan', 'Exp 1 – Dari', 'Exp 1 – Hingga',
        'Exp 2 – Jawatan', 'Exp 2 – Majikan', 'Exp 2 – Dari', 'Exp 2 – Hingga',
        // Section I
        'Penerbitan 1', 'Penerbitan 2', 'Penerbitan 3',
        // Scopus & CV
        'Scopus', 'Transkrip/CV',
        // Status
        'Status',
    ...
    fullApps.forEach((app, i) => {
        ...
        rows.push([
            i + 1,
            // A
            app.applicantName||'', d.newIC||'', d.oldIC||'', d.dob||'', d.age||'', d.religion||'',
            ...
            // F
            d.currentPos||'', d.currentEmp||'', d.currentSalary||'', d.currentFrom||'',
            // G
            ...exp(0), ...exp(1),
            // I
            pub(0), pub(1), pub(2),
