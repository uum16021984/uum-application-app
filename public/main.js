                ...
                jobAdsHTML += `
                    <div class="card-flush">
                        ...
                        <div class="card-body">
                            ...
                            <p style="color:#4b5563;font-size:0.875rem;margin-bottom:8px;"><strong>Area of Expertise:</strong> ${job.description}</p>
                            <p style="font-size:0.8rem;color:#6b7280;margin-bottom:12px;">Grade: ${job.grade} &bull; School: ${job.school} &bull; Vacancies: ${job.vacancies ?? 1} &bull; Deadline: ${job.deadline}${expired ? ' <span style="color:#dc2626;font-weight:700;">(Closed)</span>' : ''}</p>
