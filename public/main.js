...
`).join("");
    ...
    contentArea.innerHTML = `
        ...
        function loadAdminSchoolDashboard() {
            ...
            const schoolApplications = allSchoolApplications.filter(a => a.status === 'approved');
            ...
            contentArea.innerHTML = `
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="card text-center">
                            <div class="text-3xl font-bold text-green-600">${schoolApplications.filter(a => a.schoolApproved).length}</div>
