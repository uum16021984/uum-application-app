                ...
                jobAdsHTML += `
                    <div class="card-flush">
                        ...
                        <div class="card-body">
                            ...
                            <p style="color:#4b5563;font-size:0.875rem;margin-bottom:8px;"><strong>Area of Expertise:</strong> ${job.description}</p>
                            <p style="font-size:0.8rem;color:#6b7280;margin-bottom:12px;">Grade: ${job.grade} &bull; School: ${job.school} &bull; Vacancies: ${job.vacancies ?? 1} (${job.approvedCount ?? 0} approved) &bull; Deadline: ${job.deadline}${expired ? ' <span style="color:#dc2626;font-weight:700;">(Closed)</span>' : ''}</p>
                            <div style="display:flex;justify-content:space-between;align-items:center;font-size:0.8rem;font-weight:600;">
                                <span style="color:${expired ? '#6b7280' : (isFull ? '#dc2626' : '#15803d')};">
                                    <i class="fas ${expired ? 'fa-clock' : (isFull ? 'fa-ban' : 'fa-check-circle')}" style="margin-right:5px;"></i>${expired ? 'Closed' : (isFull ? 'Full' : 'Available')}
                                </span>
    ...
    return `
        <div class="card-flush">
            ...
            <div class="card-body">
                ...
                :
                    `<span style="color:#6b7280;font-weight:700;"><i class="fas fa-clock" style="margin-right:4px;"></i>Closed</span>`
                }
            </div>
        </div>
    `;
