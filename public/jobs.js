...
function previewJobImage(input) {
  ...
  reader.onload = (e) => {
    ...
    document.getElementById('jobImagePreview').style.display = 'block';
  };
...
function clearJobImage() {
  ...
  document.getElementById('jobImagePreview').style.display = 'none';
}
...
function editJobAd(jobId) {
  ...
  clearJobImage();
  if (job.image) {
    document.getElementById('jobImagePreviewImg').src = job.image;
    document.getElementById('jobImagePreview').style.display = 'block';
  }
...
async function saveJobAd() {
  ...
  // New file takes priority; otherwise keep existing image for edits
