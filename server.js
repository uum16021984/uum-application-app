...
// ── Deadline handling ──────────────────────────────────────────────────────────
// Expired jobs are no longer auto-deleted. They stay in the database and are
// simply shown as "Expired" in the UI, with new applications blocked (see
// routes/applications.js and the isJobOpen() checks in public/main.js).
// Existing applications (pending, approved, or rejected) are preserved.
